...
class SendOrdersCommandTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->app->bind(SendOrdersUseCase::class, function () {
            ...
            $guzzle = new Client([
                'handler' => function (RequestInterface $request) {
                    ...
                    $this->assertSame('/api/import-orders', $request->getUri()->getPath(), __FILE__ . ':' . __LINE__);
        ...
        $this->app->bind(ChatWorkService::class, function () {
            ...
            return new ChatWorkService('', '', $guzzle);
        });
    ...
    {
        $status = $this->artisan->call('app:send-orders', [
            'date' => '20180629',
        ]);

        $this->assertSame(0, $status);
        $this->assertJsonFileEqualsJsonFile(__DIR__ . '/send-orders-20180629.json', self::OUTPUT_PATH);
    }
    ...
    public function execute_20180630()
    {
        ...
        $this->assertSame(0, $status);
        $this->assertJsonFileEqualsJsonFile(__DIR__ . '/send-orders-20180630.json', self::OUTPUT_PATH);
    }
}
